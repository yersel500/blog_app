Rails.application.routes.draw do
  ...
  post 'users/:user_id/posts/:post_id/comment', to: 'comments#create', as: 'post_comments'
  get 'users/:user_id/posts/:post_id/comment/:id', to: 'comments#show', as: 'user_post_comment'
  delete 'users/:user_id/posts/:post_id/comment/:id', to: 'comments#destroy', as: 'comment_destroy'
